...
def init_demo():
    ...
    cursor.execute('INSERT INTO events VALUES (%d, "Опознано животное", "пантера")' % (t -90))
    ...
    cursor.execute('INSERT INTO events VALUES (%d, "Опознано животное", "пантера")' % (t - 30))
    cursor.execute('INSERT INTO events VALUES (%d, "Движение по камере", "")' % (t - 20))
    cursor.execute('INSERT INTO events VALUES (%d, "Опознано животное", "пантера")' % (t - 10))
